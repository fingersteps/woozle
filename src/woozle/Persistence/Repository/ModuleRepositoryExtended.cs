                ...
                foreach(var item in result)
                {
                    ...
                    if(module == null)
                    {
                        module = new ModuleForMandator()
                        {
                            ...
                            Icon = item.Module.Icon, Functions = new FixupCollection<Function>()};
                        module.Translation.TranslationItems = new FixupCollection<TranslationItem>();
                    ...
                    if (function == null)
                    {
                        ...
                        function.Translation.TranslationItems = new FixupCollection<TranslationItem>();
                        if (item.ModuleTranslationItem != null)
                        {
