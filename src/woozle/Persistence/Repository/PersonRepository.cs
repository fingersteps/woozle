...
namespace Woozle.Persistence.Repository
{
    public partial class PersonRepository  : AbstractRepository<Person>
    {
    	...
    	catch (Exception e)
    	{
    	 ...
    	 public override void Delete(Person entity, Session session) 
    	 { 
    		try
    		{
    			var stopwatch = new Stopwatch();
    			...
    			Context.Commit();
    			stopwatch.Stop();
    			this.Logger.Info(string.Format("Commit '{0}' Delete, took {1} ms", "Person", stopwatch.ElapsedMilliseconds));
    		}
    	catch (Exception e)
    	{
    		this.Logger.Error(e.Message); 
