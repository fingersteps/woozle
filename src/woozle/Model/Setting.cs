...
{
    [Serializable]
    public partial class Setting : WoozleObject, IMandatorCapable, IManagedConcurrency
    {
        private string eventmanagementplanningemail;
        private string eventmanagementplanningmobile;
        private byte[] changecounter;
    
        public string EventManagementPlanningEMail 
    	{ 
    		get { return this.eventmanagementplanningemail;} 
    		set { 
    			if(this.eventmanagementplanningemail != value)
    			{
    				this.eventmanagementplanningemail = value;
    				OnPropertyChanged("EventManagementPlanningEMail");
    			}
    		}
    	}
        public string EventManagementPlanningMobile 
    	{ 
    		get { return this.eventmanagementplanningmobile;} 
    		set { 
    			if(this.eventmanagementplanningmobile != value)
    			{
    				this.eventmanagementplanningmobile = value;
    				OnPropertyChanged("EventManagementPlanningMobile");
    			}
    		}
    	}
