...
{
    public partial class NumberRangeRepository  : AbstractRepository<NumberRange>
    {
    
    	public NumberRangeRepository(IEfUnitOfWork Context) : base(Context)
    	{
    	}
    
    
    	 public override NumberRange Synchronize(NumberRange entity, SessionData sessionData) 
    	 { 
    		try
    		{
